...
class InlineResponse200(object):
    ...
    def level(self, level):
        ...
        the level at which the DAS should operate for this test. as given in the CP definition,    * a - no perturbations, no adaptation, no power model    * b - perturbations, but no adaptation, no power model    * c - perturbations and adaptation, with charge and         discharge power models provided and learned  * d - perturbations and adaptation, with charge and discharge power models provided and learned by online learning # noqa: E501
