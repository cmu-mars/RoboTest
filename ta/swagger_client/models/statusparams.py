...
class Statusparams(object):
    ...
    def __init__(self, status=None, x=None, y=None, charge=None, sim_time=None, plan=None):  # noqa: E501
    ...
    def status(self):
        ...
        one of the possible status codes   * offline-learning-started - the offline learning phase has started   * online-learning-done - the offline learning phase has been done  * online-learning-started - the online learning phase has started   * online-learning-done - the online learning phase has been done * adapt-started - the SUT has started adapting and                    cannot be perturbed   * adapt-done - the SUT has finished adapting   * charging-started - the turtlebot is currently charging   * charging-done - the turtlebot has stopped charging   * at-waypoint - the turtlebot has arrived at one of the    waypoints in the list received from /ready   * live - the system is ready to recieve perturbs  # noqa: E501
    ...
    def status(self, status):
        ...
        allowed_values = ["offline-learning-started", "offline-learning-done", "online-learning-started", "online-learning-done", "adapt-started", "adapt-done", "charging-started", "charging-done", "at-waypoint", "live"]  # noqa: E501
