...
class CP1InternalStatus(Model):
    ...
    def status(self, status: str):
        ...
        :type status: str
        """
        allowed_values = ["offline-learning-started", "offline-learning-done", "online-learning-started", "online-learning-done", "adapt-started", "adapt-done", "charging-started", "charging-done", "parsing-error", "learning-error", "other-error", "RAINBOW_READY", "MISSION_SUCCEEDED", "MISSION_FAILED", "ADAPTING", "ADAPTED", "ADAPTED_FAILED", "PLAN", "learning-requested"]  # noqa: E501
